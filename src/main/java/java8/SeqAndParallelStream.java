...
public class SeqAndParallelStream {
	...
	public static void main(String[] args) {
		...
		System.out.println("Time taken to count elements using sequential streams: " + (endNanoSec - startNanoSec)
				+ " nanoSeconds");
		...
		System.out.println(
				"Time taken to count elements using parallel streams: " + (endNanoSec - startNanoSec) + " nanoSeconds");
